...
class Free_Water_LS(Task):
    ...
    * reporting the response afterwards
    ...
    HARDWARE = {
        'POKES':{
            'left_poke': autopilot.hardware.gpio.Digital_In,
            'center_poke': autopilot.hardware.gpio.Digital_In,
            'right_poke': autopilot.hardware.gpio.Digital_In
        },
        'LEDS':{
            # TODO: use LEDs, RGB vs. white LED option in init
            'cue1': autopilot.hardware.gpio.LED_RGB,
            'cue2': autopilot.hardware.gpio.LED_RGB,
            'cue3': autopilot.hardware.gpio.LED_RGB
        },
        'PORTS':{
            'reward1': autopilot.hardware.gpio.Solenoid,
            'reward2': autopilot.hardware.gpio.Solenoid,
            'reward3': autopilot.hardware.gpio.Solenoid
        }
    }
